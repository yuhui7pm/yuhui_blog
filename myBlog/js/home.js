...
$(()=>{
	$('.bar1').css('background-color','#D56464');//改变tapBar的颜色
...
function picRoll(buttonLeft,buttonRight){
	...
	buttonLeft.onclick = function(){
		...
		document.getElementById('album').children[(num_negative+1)%4].setAttribute('style','filter: opacity(0.7);'); //让上一张照片恢复透明
	...
	document.getElementById("album").onclick = function(e){
		...
		lastClickedPic = rotateIndex;//储存上一张被点击的图片
